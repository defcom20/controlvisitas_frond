      ...
      <q-card-section class="bg-white q-gutter-y-sm" rounded>
        <div class="row q-gutter-x-md">
          ...
          <div class="col">
            ...
            <q-input class="shadow bg-white" outlined v-model="vv.usuario.$model" :dense="true" />
            <small v-if="vv.usuario.$error" class="text-red">Campo requerido</small>
          </div>
          <div class="col">
            <div class="text-caption text-grey-8">Contraseña</div>
            <q-input class="shadow bg-white" outlined v-model="vv.password.$model" :dense="true" />
        ...
        <div class="row q-gutter-x-md">
          <div class="col">
            ...
            <q-select class="shadow bg-white" outlined :dense="true" v-model="vv.sede_id.$model" use-input hide-selected
              fill-input input-debounce="0" :options="dataArea.sede[0]" option-value="id" option-label="nombre">
          ...
          <div class="col">
            ...
            <q-select class="shadow bg-white" outlined :dense="true" v-model="vv.tipo_role_id.$model" use-input hide-selected fill-input
              input-debounce="0" :options="dataArea.rol[0]" option-value="id" option-label="nombre">
              <template v-slot:no-option>
                <q-item>
                  <q-item-section class="text-grey"> No results </q-item-section>
                </q-item>
...
import { guardarUsuario } from '../../services/usuarioServices'
